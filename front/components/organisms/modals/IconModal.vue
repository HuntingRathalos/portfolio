<template>
  <v-dialog v-model="openIconModal" max-width="250px">
    <template #activator="{ on, attrs }">
      <v-btn block height="24px" v-bind="attrs" v-on="on">
        アイコンを選択する
      </v-btn>
    </template>
    <v-card>
...
<script>
import SingleIcon from '../../molecules/icons/SingleIcon.vue'
export default {
  components: { SingleIcon },
  data: () => ({
    openIconModal: false,
    iconCodes: [
      {
